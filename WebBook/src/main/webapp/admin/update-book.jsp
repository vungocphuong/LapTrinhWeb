...
%>
    ...
    <div class="container" style="margin-top: 200px; margin-left: 150px;font-size: 15px;">
		<form action="<%=url%>/admin-ctr?action=update-book&bid=${book.bid}&ck=true" class="form" method="post" name="form_id" id="form_id" enctype="multipart/form-data"> <!-- enctype="multipart/form-data": hỗ trợ upload file image -->
			<div class="row">
				<div class="col-sm-6">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="mb-3">
							  ...
							  <input type="number" class="form-control" id="sold" name="sold" value="${book.sold }">
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="mb-3">
							  	<input class="btn btn-primary form-control" type="submit" class="form-control" value="Update" 
				...
				<div class="col-sm-6">
					...
					<div class="mb-3">
						<img src="<%=url%>/${book.coverurl}" alt="khong co anh hien thi"/ id="image" height="200" name="image">
					</div>
