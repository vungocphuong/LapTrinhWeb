...
<body>
	<div class="app">
        ...
        <header class="header">
            <div class="grid wide">
                ...
                <div class="header-with-search">
					...
					<form class="header__search" action="<%=url%>/admin-ctr?action=search-supplier" method="post" enctype="multipart/form-data">
	                    <div class="header__search">
	                        <div class="header__search-input-wrap">
	                            <!-- Header search input -->
	                            <input type="text" class="header__search-input" placeholder="Nhập để tìm kiếm nhà cung cấp" name="txtSearch" id="txtSearch" value="${txtSearch}">
        ...
        <div class="tableSup">
        	<a href="<%=url %>/home" class="button button4">Quay lại trang chủ</a>
			   	...
			   	<c:forEach items="${listSupplier}" var="o">
			   		<tr>
			    		<td>${o.sid }</td>
				      	...
				      	<td>${o.address }</td>
				      	<td>${o.phone }</td>
				      	<%-- <td><a href="<%=url %>/admin-ctr?action=choose-supplier&sid=${o.sid}" class="button button1">Chọn</a></td> --%>
				      	<td><input type="button" class="button button4"  value="Chọn" onclick="window.location.href='<%=url %>/admin-ctr?action=choose-supplier&sid=${o.sid}'"/></td>
				    </tr>
			    </c:forEach>
