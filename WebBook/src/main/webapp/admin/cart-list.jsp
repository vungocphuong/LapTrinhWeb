...
<body>
	  ...
	  <table id="cart" class="table table-hover table-condensed">
	    ...
	    <tbody>
	      <c:forEach items="${receipt.items}" var="item">
	      	<form class="form" method="post" name="form_cart_list" id="form_cart_list" enctype="multipart/form-data" action="<%=url%>/admin-ctr?action=update-cart">
	      		<input type="hidden" name="action" value="update-cart"/>
	      		<tr>
		        <td data-th="Product">
		          <div class="row">
		            <div class="col-sm-2 hidden-xs"><img src="${item.book.coverurl}" alt="..." class="img-responsive" height="100"/></div>
		            <div class="col-sm-10">
		        ...
		        <td class="actions" data-th="">
		          ...
		          <a href="<%=url %>/admin-ctr?action=delete-cart&bid=${item.book.bid}" role="button" class="button button3">Delete</a>
		        </td>
		      </tr>
	      	</form>
	      </c:forEach>
	    ...
	    <tfoot>
	      <tr class="visible-xs">
	        <td class="text-center"><strong>Total ${receipt.total}</strong></td>
	      </tr>
	      <tr>
	        <td><a href="<%=url%>/admin/find-imported-book.jsp" class="button button2"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
	        <td colspan="2" class="hidden-xs"></td>
	        <td class="hidden-xs text-center"><strong>Total ${receipt.total}</strong></td>
	        <td><a href="<%=url%>/admin/check-out.jsp" class="button button1">Checkout <i class="fa fa-angle-right"></i></a></td>
	      </tr>
	    </tfoot>
	  </table>
	</div>
	<%}else{ %>
		<div class="container" style="width:1600px;margin-top: 150px;">
		  ...
		  <h3>Quay trở về <a href="<%=url%>/admin/find-imported-book.jsp">Nhập hàng</a></h3>
		</div>
	<%} %>
</body>
</html>