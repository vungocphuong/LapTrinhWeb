...
<body>
    ...
    <div class="container" style="margin-top: 150px;">
		<form class="form" method="post" name="check_out_form" id="check_out_form" enctype="multipart/form-data" action="khach-hang">
			...
			<div class="mb-3">
				<label for="deliveryaddress" class="form-label">Delivery Address<span class="red">*</span></label>
				<textarea class="form-control" placeholder="Hãy nhập địa chỉ bạn muốn nhân hàng" id="deliveryaddress" name="deliveryaddress" required="required"></textarea>
			...
			<table id="cart" class="table table-hover table-condensed">
			    ...
			    <tbody>
			      <c:forEach items="${order.items}" var="item">
			      	<form class="form" method="post" name="form_id" id="form_id" enctype="multipart/form-data" action="updatecart">
			      		<tr>
				        <td data-th="Product">
				          <div class="row">
				            <div class="col-sm-2 hidden-xs"><img src="${item.book.coverurl}" alt="..." class="img-responsive" width="95"/></div>
				            <div class="col-sm-10">
